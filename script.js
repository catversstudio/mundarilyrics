...
function displayVideos(videos) {
    videos.forEach(video => {
        ...
        // Note: added playsinline and enablejsapi for better background handling
        card.innerHTML = `
...
// --- PLAY VIDEO & SAVE HISTORY ---
function playVideo(element, videoId, title, thumb) {
    // 1. Save to History
    saveToHistory(videoId, title, thumb);

    // 2. Play Video
    // 'playsinline' helps keep video active in some mobile scenarios
    element.innerHTML = `
        <iframe 
